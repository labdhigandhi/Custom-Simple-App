...
public class MainActivity extends AppCompatActivity {
    ...
    private String jsonURL = "https://flowerabsolute.com/labdhi/example1.json";
        ...
        try {
            ...
            if (jsonObject.getString("status").equals("success")) {
                ...
                for (int i = 0; i < dataArray.length(); i++) {
                    ...
                    playersModel.setName(dataobj.getString("employee_name"));
                    playersModel.setSalary(dataobj.getString("employee_salary"));
                    playersModel.setAge(dataobj.getString("employee_age"));
                  //  playersModel.setImgURL(dataobj.getString("profile_image"));
